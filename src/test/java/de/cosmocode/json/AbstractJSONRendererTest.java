...
public abstract class AbstractJSONRendererTest {
    ...
    public static final short POSITIVE_SHORT = 21766;
    public static final short ZERO_SHORT = 0;
    public static final short NEGATIVE_SHORT = -21766;
    
    public static final char POSITIVE_CHAR = 65;
    public static final char ZERO_CHAR = 0;
    public static final char POSITIVE_CHAR_LITERAL = 'A';
    public static final char ZERO_CHAR_LITERAL = '\u0000';
    
    public static final int POSITIVE_INT = 250768;
    public static final int ZERO_INT = 0;
    public static final int NEGATIVE_INT = -250768;
    
    public static final long POSITIVE_LONG = 17258985684L;
    public static final long ZERO_LONG = 0;
    public static final long NEGATIVE_LONG = -17258985684L;
    
    public static final float POSITIVE_FLOAT = 123.456789f;
    public static final float ZERO_FLOAT = 0.0f;
    public static final float NEGATIVE_FLOAT = -123.456789f;
    
    public static final double POSITIVE_DOUBLE = 123.456789f;
    public static final double ZERO_DOUBLE = 0;
    public static final double NEGATIVE_DOUBLE = -123.456789f;
    
    public static final BigInteger POSITIVE_BIG_INTEGER = new BigInteger("9999999999999999999");
    public static final BigInteger ZERO_BIG_INTEGER = new BigInteger("0");
    public static final BigInteger NEGATIVE_BIG_INTEGER = new BigInteger("-9999999999999999999");
    public static final BigInteger NULL_BIG_INTEGER = null;
    
    public static final BigInteger POSITIVE_BIG_DECIMAL = new BigInteger("9999999999999999999");
    public static final BigInteger ZERO_BIG_DECIMAL = new BigInteger("0");
    public static final BigInteger NEGATIVE_BIG_DECIMAL = new BigInteger("-9999999999999999999");
    public static final BigInteger NULL_BIG_DECIMAL = null;
    
    public static final Date TODAY_DATE = new Date();
    public static final Date EPOCH_START_DATE = new Date(0);
    ...
    public static final TestEnum NULL_ENUM = null;
    
    public static final CharSequence STRING_CHAR_SEQUENCE = "a-string";
    public static final CharSequence STRING_BUILDER_CHAR_SEQUENCE;
    public static final CharSequence STRING_BUFFER_CHAR_SEQUENCE;
    public static final CharSequence NULL_CHAR_SEQUENCE = null;
    ...
    public static final Object[] SIZE_ONE_ARRAY = new Object[] {
        "value"
    };
    public static final Object[] SIZE_THREE_ARRAY = new Object[] {
    ...
    public static final Map<Object, Object> SIZE_THREE_MAP = ImmutableMap.<Object, Object>of(
    ...
    public static final NoObjectContext SIZE_ONE_NO_OBJECT_CONTEXT = new NoObjectContext() {
    ...
    public static final NoObjectContext SIZE_THREE_NO_OBJECT_CONTEXT = new NoObjectContext() {
    ...
    public static final NoObjectContext NULL_NO_OBJECT_CONTEXT = null;
    
    public static final JSONEncoder EMPTY_ENCODER = new JSONEncoder() {
    ...
    public static final JSONEncoder SIZE_ONE_ENCODER = new JSONEncoder() {
    ...
    public static final JSONEncoder SIZE_THREE_ENCODER = new JSONEncoder() {
